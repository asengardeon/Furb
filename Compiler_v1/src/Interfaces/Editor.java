...
public class Editor extends JFrame {
	...
	public Editor() {
		...
		gl_pContainer.setHorizontalGroup(gl_pContainer.createParallelGroup(Alignment.LEADING).addGroup(gl_pContainer.createSequentialGroup().addComponent(pButtons, GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(pContainerEditor, GroupLayout.DEFAULT_SIZE, 627, Short.MAX_VALUE)).addComponent(pSatusBar, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		gl_pContainer.setVerticalGroup(gl_pContainer.createParallelGroup(Alignment.TRAILING).addGroup(gl_pContainer.createSequentialGroup().addGroup(gl_pContainer.createParallelGroup(Alignment.LEADING).addComponent(pButtons, GroupLayout.DEFAULT_SIZE, 425, Short.MAX_VALUE).addComponent(pContainerEditor, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 425, Short.MAX_VALUE)).addPreferredGap(ComponentPlacement.RELATED).addComponent(pSatusBar, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)));
		...
		gl_pSatusBar.setHorizontalGroup(gl_pSatusBar.createParallelGroup(Alignment.LEADING).addGroup(gl_pSatusBar.createSequentialGroup().addComponent(lChange, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED).addComponent(lDirectory, GroupLayout.DEFAULT_SIZE, 632, Short.MAX_VALUE).addGap(1)));
		gl_pSatusBar.setVerticalGroup(gl_pSatusBar.createParallelGroup(Alignment.LEADING).addComponent(lChange, GroupLayout.DEFAULT_SIZE, 19, Short.MAX_VALUE).addComponent(lDirectory, GroupLayout.DEFAULT_SIZE, 19, Short.MAX_VALUE));
		...
		aPMessages.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
		aPMessages.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
	...
	public void openSource() {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Não foi possível abrir o arquivo: " + patch);
			}
		}
	}
	...
	public void compile() {
		Compile.compile(tASources.getEditor().getText(), tAMessages);
	}
