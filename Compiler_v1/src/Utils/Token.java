...
public class Token {
	...
	// } else if (id >= Constants.MAIS.getId() && id <=
	// Constants.DOIS_PONTOS.getId()) {
	...
	public final Constants getTokenClass() {

		if (id == Constants.IDENTIFICADOR.getId()) {
			return Constants.IDENTIFICADOR;
		} else if (id == Constants.REAL.getId()) {
			return Constants.REAL;
		} else if (id == Constants.LITERAL.getId()) {
			return Constants.LITERAL;
		} else if (id >= Constants.MAIS.getId() && id <= Constants.DOIS_PONTOS.getId()) {
			return Constants.MAIS;
		} else if (id >= Constants.ADD.getId() && id <= Constants.WRITE.getId()) {
